...
def create_bird_blueprint(bird_view_factory, bird_search_controller, bird_search_view_factory):
  ...
  def search():
    ...
    result_items = bird_search_view_factory.create_search_result_items(bird_matches)
