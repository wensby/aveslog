...
class AccountRegistrationController:
  ...
  def __init__(self, account_factory: AccountFactory, account_repository,
        mail_dispatcher, link_factory, person_repository):
...
class PasswordResetController:
  ...
  def __init__(self, account_repository, password_repository, link_factory,
        mail_dispatcher):
    self.account_repository = account_repository
